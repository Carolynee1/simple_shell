...
/**
 * _my_env - Prints the current environment variables
 * @info: Pointer to info_t struct
 *
...
/**
 * _my_setenv - Sets the value of an environment variable
 * @info: Pointer to info_t struct
 *
...
/**
 * _my_unsetenv - Removes an environment variable
 * @info: Pointer to info_t struct
 *
 * Return: 0 on success, 2 on failure
 */
...
/**
 * populate_env_list - Populates the env list with current
